...
def get_tran_weight(in_channels, out_channels, kernel_size):
    """
...
def bilinear_upsampling(in_channels, out_channels, kernel_size, stride, pad):
    initial_weight = get_tran_weight(in_channels, out_channels, kernel_size)
