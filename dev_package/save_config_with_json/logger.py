...
if __name__ == '__main__':
    ...
    metric_logger.update(**{'loss_objectness':2, 'loss_rpn_box_reg':1, 'loss_box_reg':1, 'reid_cls':1, 'loss_detection':6, "loss_reid":7})
    metric_logger.update(batch_time=2)
    metric_logger.print_log(1,1,20)